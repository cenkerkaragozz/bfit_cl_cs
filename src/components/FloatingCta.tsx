  ...
  return (
    ...
    >
      ...
      >
        ...
        <span
          className="pointer-events-none absolute right-full mr-3 origin-right whitespace-nowrap rounded-full bg-[#241D18] px-4 py-2 text-[13px] font-extrabold text-white opacity-0 shadow-[0_12px_28px_rgba(36,29,24,0.22)] transition-all duration-300 group-hover:opacity-100 max-sm:hidden"
        >
          WhatsApp&apos;tan Yazın
        </span>
